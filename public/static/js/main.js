...
(function () {
    ...
    document.querySelectorAll('.navmenu .dropdown ul a').forEach(link => {
    ...
    function navmenuScrollspy() {
        ...
        navmenulinks.forEach(link => {
            ...
            // Tambahkan offset agar section berikutnya aktif sedikit lebih awal
        ...
        if (window.scrollY < 150) {
            const homeLink = document.querySelector('#navmenu a[data-page="home"]');
            if (homeLink) {
                document.querySelectorAll('#navmenu a.active').forEach(a => a.classList.remove('active'));
