...
@section('title', 'Detail Data Misi Sekolah - SMAN 6 Tangerang')
@section('meta-description', 'Detail data misi sekolah SMAN 6 Tangerang')
@section('meta-keywords', 'master data, detail misi sekolah, detail misi, misi, mission, sman 6, sman 6 tangerang')
@section('content')
            ...
            <div class="card my-0">
                <div
                    ...
                    <div class="d-flex flex-column">
                        <h3 class="p-0 m-0 mb-1 fw-semibold">Detail Misi Sekolah</h3>
                        <p class="p-0 m-0 fw-medium text-muted">Informasi lengkap misi sekolah: {{ $mission->id ?? 'N/A' }}</p>
                    </div>
    ...
    <div class="row">
        <div class="col-lg-8 mb-4 mb-lg-0">
            <div class="card my-0">
                <div class="card-body">
                    <h4 class="card-title fw-semibold mb-4">Data Misi Sekolah</h4>
                    <div class="row mb-3">
                        <div class="col-md-4 text-muted">Konten Misi</div>
                        <div class="col-md-8 fw-medium">{{ $mission->content ?? '-' }}</div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-4 text-muted">Urutan</div>
                        <div class="col-md-8 fw-medium">{{ $mission->item_order ?? '-' }}</div>
                    </div>
                    <h4 class="card-title fw-semibold mt-4 mb-3">Informasi Sistem</h4>
                    <div class="row mb-3">
                        <div class="col-md-4 text-muted">ID Misi</div>
            ...
            <div class="card my-0">
                <div class="card-body">
                    ...
                    <a href="{{ route('dashboard.admin.master-data.missions.edit', $mission->id) }}"
                        ...
                        <i class="ti ti-pencil me-1"></i> Edit Misi
                    </a>
                    ...
                    <p class="text-muted small">
                        Halaman ini hanya menampilkan detail data yang tersimpan. Untuk mengubah, klik tombol "Edit Misi".
                    </p>
                </div>
            </div>
        </div>
